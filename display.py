...
class IntervalRect(object):
    ...
    def draw(self, surface):
        px, py, w, h = self.rect
        if self.interval.resource is not None:
            fillColor = SchedulingDisplayColors.INTERVAL_FILLS[min(self.interval.resource, 4)]
        else:
            fillColor = SchedulingDisplayColors.INTERVAL_FILLS[0]
...
class SchedulingDisplayColors(object):
    if IS_FOR_PRINT:
        ...
        INTERVAL_FILLS  = [(128, 128, 128), (20, 20, 128), (128, 20, 20), (20, 128, 20), (128, 128, 20)]
    else:
