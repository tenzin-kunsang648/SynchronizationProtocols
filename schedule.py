    ...
    def postProcessIntervals(self, endTime):
        ...
        for (i, interval) in enumerate(self.intervals):
            if i < len(self.intervals) - 1:
                ...
                interval.updateIntervalEnd(nextInterval.startTime, self.taskSet.getTaskById(interval.taskId).getJobById(interval.jobId).isCompleted())
            else:
